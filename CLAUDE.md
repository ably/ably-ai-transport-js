...
`@ably/ai-transport` — Ably transport and codecs for building AI applications with Ably. Ships as a single npm package with several entry points; see the table in `.claude/rules/ABSTRACTIONS.md` and the `exports` map in `package.json`.
