...
The demo renders a **linear thread**: transport events are demultiplexed by codec-message-id, merged per message, and listed in first-seen order. There is no branch navigation.
