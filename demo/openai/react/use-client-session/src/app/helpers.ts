 ...
 * `output_text` content parts of its message items, plus any `refusal`. Used by
 * the bubble to render a turn and to seed the inline edit form. Non-text items
 * (none in this text-only demo) contribute nothing.
 */
