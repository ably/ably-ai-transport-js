...
import type { OpenAIInput, OpenAIOutput, OpenAIProjection, OpenAITurn } from '@ably/ai-transport/openai';

export const SessionHooks = createSessionHooks<OpenAIInput, OpenAIOutput, OpenAIProjection, OpenAITurn>();
