...
import type { OpenAIMessage, OpenAIOutput, OpenAIProjection, OpenAISessionInput } from '@ably/ai-transport/openai';
 ...
 */
export const SessionHooks = createSessionHooks<OpenAISessionInput, OpenAIOutput, OpenAIProjection, OpenAIMessage>();
