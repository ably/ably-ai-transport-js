...
function ChatWhenReady({ channelName, clientId, limit }: { channelName: string; clientId: string; limit?: number }) {
  ...
  return (
    <ChatTransportProvider
      ...
      // Opt the session's channel into LiveObjects. The session unions these
      // with the modes AI Transport always needs, so the transport itself is
      // unaffected. OBJECT_MODES is a module-level constant, satisfying the
      // provider's requirement that channelModes stays stable.
