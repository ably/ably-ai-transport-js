      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="border-t border-zinc-800">
          ...
          {connected ? (
            ...
            <div className="px-4 py-3 text-sm text-zinc-600">Connecting channel…</div>
          )}
        </div>
      </div>
      <DebugPane
    ...
    <header className="flex h-16 flex-shrink-0 items-center gap-3 border-b border-zinc-800 px-4">
      <div className="flex flex-col gap-1.5">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-sm font-medium text-zinc-300">Ably AI — Vercel UI SDK — DB hydration</h1>
        </div>
