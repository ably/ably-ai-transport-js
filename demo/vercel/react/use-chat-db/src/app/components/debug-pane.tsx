    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <Badge
          variant="secondary"
          className={
            status === 'streaming' ? 'text-emerald-400' : status === 'submitted' ? 'text-amber-400' : undefined
          }
        >
          {status}
        </Badge>
        ...
        callbackLog.map((entry, idx) => (
          ...
          >
            <div className="mb-1 flex items-center gap-2">
              ...
              <Badge
                variant={entry.type === 'onError' ? 'destructive' : 'secondary'}
        ...
        clientToolLog.map((entry) => (
          ...
          >
            <div className="mb-1 flex items-center gap-2">
              ...
              <Badge
                variant="secondary"
                className={entry.status === 'done' ? 'text-emerald-400' : 'text-amber-400'}
              >
                {entry.status}
              </Badge>
            </div>
