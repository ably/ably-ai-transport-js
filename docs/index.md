...
**Add a feature** - the [Features](features/) section covers streaming, cancellation, interruption, optimistic updates, history, conversation branching, multi-client sync, and presence.
