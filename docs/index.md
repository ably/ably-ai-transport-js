...
**Add a feature** - the [Features](features/) section covers streaming, cancellation, interruption, optimistic updates, history, conversation branching, and multi-client sync.
