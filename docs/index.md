...
**Add a feature** - the [Features](features/) section covers streaming, cancellation, interruption, optimistic updates, history, [database hydration](features/database-hydration.md), conversation branching, multi-client sync, presence, LiveObjects, and [sharing the channel with your own Pub/Sub traffic](features/channel-sharing.md).
