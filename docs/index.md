...
| `@ably/ai-transport/react`        | React hooks for the generic transport (`useClientTransport`, `useView`, `useSend`, etc.) |
...
**Add a feature** - the [Features](features/) section covers streaming, cancellation, interruption, optimistic updates, history, conversation branching, multi-client sync, and tool calls.
