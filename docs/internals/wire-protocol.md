...
| `x-ably-event-id`         | string                                                   | Per-event identifier on each client-published event in a send. The invocation body lists every inputEventId; the agent's input-event lookup waits for all of them on the channel before starting LLM work                                                                                                                                                                                                                                                                                 |
