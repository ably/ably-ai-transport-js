...
| ---------------- | ---------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ai-run-start`   | Server → Channel | `run-id`, `run-client-id`                                           | `parent`, `fork-of`, `msg-regenerate`, `invocation-id`, `input-client-id`, `input-codec-message-id`                     | Signal that a run has started (its first invocation)                                                                                                                                                                                                                                                                      |
...
| `regenerate()` / `edit()`                                         | Look up the target message in the tree by `codec-message-id` to compute branch routing: `regenerate()` resolves `target` (→ `msg-regenerate`) and `parent`; `edit()` resolves `fork-of` and `parent`. Neither sends history — the agent assembles it from the channel via `loadConversation`                                                                     |
