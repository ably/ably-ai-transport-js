/**
 * Regenerate — durable-execution workflow.
 *
...
/**
 * One hop of the agent loop. Identical to basic-chat.
...
/**
 * Top-level workflow. Unchanged from basic-chat.
 * @param invocationData - The serialized {@link InvocationData} from the starting HTTP request.
 */
export const regenerateWorkflow = async (invocationData: InvocationData): Promise<void> => {
  'use workflow';
