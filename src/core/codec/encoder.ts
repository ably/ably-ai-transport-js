...
export interface EncoderCore {
   ...
   * @throws {Ably.ErrorInfo} InvalidArgument if there is no active stream for `streamId`; TransportClosed if the encoder has been closed; StreamedMessageFinalizeFailed if a failed append cannot be recovered during the flush.
   */
   ...
   * @throws {Ably.ErrorInfo} TransportClosed if the core is closed; StreamedMessageFinalizeFailed if a failed append cannot be recovered during the flush.
   */
