 ...
 *
 * Owns every piece of state involved in the `view.send(...)` →
 * `activeRun.steer(...)` → lifecycle-event lifecycle:
 ...
 *      inbound message;
 *   3. exposing `steer(runIdPromise, input)` as the `ActiveRun.steer`
 *      method;
