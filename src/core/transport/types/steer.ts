 ...
 * messages. Each response carries a `steer-codec-message-ids` header listing
 * the steer codec-message-ids the agent's loop drained since the step attempt
 ...
 *
 * - `consumed: true` — the steer's codec-message-id appears in the union of
 ...
 * - `consumed: false` — the steer's codec-message-id never appeared on any
