...
export interface LoggerOptions {
  /** Optional handler that receives formatted log records. Defaults to {@link consoleLogger}. */
  logHandler?: LogHandler;
  /** Minimum level at which messages are emitted. Messages below this level are dropped. */
  logLevel: LogLevel;
}

/**
 * Create a {@link Logger} instance from the provided options.
