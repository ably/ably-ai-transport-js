 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- log context is deliberately open-shaped: a caller passes arbitrary values and the handler only ever serialises them
