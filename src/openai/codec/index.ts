 ...
 *
 * This increment supports streamed assistant text and a plain user message;
 * function calls, reasoning, refusals, hosted tools, and mid-stream-join repair
 * (`decodeLifecycle`) are added in later increments.
 *
 * ```ts
