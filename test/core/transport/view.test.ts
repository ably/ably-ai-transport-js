...
const createMockSendDelegate = (): SendDelegate<TestInput, TestOutput, TestMessage> =>
  // eslint-disable-next-line @typescript-eslint/promise-function-async -- mock returns Promise.resolve directly
  vi.fn(() =>
    Promise.resolve({
...
describe('DefaultView', () => {
  ...
  let sendDelegate: SendDelegate<TestInput, TestOutput, TestMessage>;
  ...
  describe('msg-anchored branch nav', () => {
    ...
    describe('regenerate target inside a regenerator Run', () => {
      ...
      it('mints a regenerate event anchored at the trailing msg-id (not at the group root)', () => {
        ...
        const mocked = sendDelegate as unknown as Mock<SendDelegate<TestInput, TestOutput, TestMessage>>;
