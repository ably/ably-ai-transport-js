/**
 * Validates that the SessionChatTransport correctly drives useChat features.
 *
 * The Ably SessionChatTransport returns a stream of the run's output chunks from
 ...
 * Ably SessionChatTransport and verifying that all useChat features function.
 */
...
describe('SessionChatTransport useChat integration — features work with the real stream', () => {
  ...
  describe('status transitions', () => {
    it('transitions through streaming on its way to ready', async () => {
      ...
      const chatTransport = createSessionChatTransport(session);
